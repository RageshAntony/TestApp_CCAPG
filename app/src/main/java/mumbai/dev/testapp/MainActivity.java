...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, CustomModel.OnCustomStateListener/*, responseinterface*/ {
    ...
    public void onClick(View v) {
        ...
        if(id==R.id.sdk)
        {
            ...
            m.setRsa_url(getString(R.string.rsa_url,ed_access_code.getText().toString().trim(),ed_order_id.getText().toString().trim())); // ed_rsa_url.getText().toString().trim()
           // m.setRsa_url(getString(R.string.rsa_post));
